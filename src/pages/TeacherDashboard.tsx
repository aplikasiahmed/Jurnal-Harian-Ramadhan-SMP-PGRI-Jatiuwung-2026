    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 sm:mb-8 space-y-4 md:space-y-0">
          <div>
            <h1 className="text-lg sm:text-xl font-bold text-gray-900">Rekap Jurnal Ramadhan</h1>
            <p className="text-xs sm:text-sm text-gray-600">SMP PGRI Jatiuwung Kota Tangerang</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 w-full md:w-auto">
            <div className="relative w-full sm:w-64">
              ...
              <Input
                ...
                className="pl-9 w-full min-h-[44px] text-sm"
                value={searchTerm}
        ...
        {loading ? (
          ...
          <Card className="text-center py-12 mx-auto max-w-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-500 text-sm sm:text-base">Belum ada data jurnal untuk tanggal ini.</p>
            </CardContent>
          </Card>
        ) : (
                  ...
                  <div className="grid grid-cols-2 gap-4 bg-gray-50 p-3 rounded-lg border">
                    <div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-xs sm:text-sm font-medium text-gray-700">{entry.shalat_tarawih ? 'Ya' : 'Tidak'}</span>
                      </div>
                    </div>
                    <div>
